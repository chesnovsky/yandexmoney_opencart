		   ...
		   <tr>
            ...
            <td>
				...
				<div class="org">
					...
					<input type="checkbox" name="yandexmoney_method_alfa" value="1" id="ym_method_6"<?php if ($yandexmoney_method_alfa){?> checked <?php } ?> /><label for="ym_method_6"><?php echo $entry_method_alfa; ?></label> <br/>
				</div>
